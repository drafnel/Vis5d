 ...
 * Of course all the support functions for getting the selected gradient and
 * setting the selection all need to be done as well.
 */
...
static GtkTargetEntry clist_target_table[] = {NULL};
/*  dnd stuff  
...
gradient_dialog_free (void)
{
  ...
  printf("Need to call gradient_editor_free here\n");
  /*
